...
const BlogPage = () => {
  ...
  const createLoading = useSelector((state) => state.blog.createLoading);
  const updateLoading = useSelector((state) => state.blog.updateLoading);
  const deleteLoading = useSelector((state) => state.blog.deleteLoading);
    ...
    setFormData({
      ...
      category_id:
        typeof blog.category_id === "object" && blog.category_id
          ...
          : blog.category_id || "",
      subcategory_id:
        typeof blog.subcategory_id === "object" && blog.subcategory_id
          ? blog.subcategory_id.id
          : blog.subcategory_id || "",
