import {
  ...
  export const menuItems = [
    { path: '/dashboard', label: 'Dashboard', icon: Home, roles: ['admin',  'editor'] },
    ...
    { path: '/dashboard/faq', label: 'FAQs', icon: RiSeoLine, roles: ['admin','editior'] },
    ...
    { path: '/dashboard/leads', label: 'Leads', icon: FileUser, roles: ['admin'] },
